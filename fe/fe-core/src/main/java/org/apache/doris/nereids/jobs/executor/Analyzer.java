...
import org.apache.doris.nereids.rules.rewrite.IvmFullRefreshMtmv;
...
public class Analyzer extends AbstractBatchJobExecutor {
    ...
    private static List<RewriteJob> buildAnalyzerJobs() {
        return jobs(
            ...
            bottomUp(new CheckAnalysis(true)),
            ...
            custom(RuleType.IVM_FULL_REFRESH_MTMV, IvmFullRefreshMtmv::new),
