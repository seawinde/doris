...
/**
 * SPI factory for creating {@link DataworksLineagePlugin} instances.
 * Discovered via {@link java.util.ServiceLoader}.
 */
public class DataworksLineagePluginFactory implements LineagePluginFactory {
    ...
    public LineagePlugin create() {
        return new DataworksLineagePlugin();
    }
}
